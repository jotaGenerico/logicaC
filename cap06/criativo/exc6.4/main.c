...
int main( void ) {
    ...
    InitWindow( 800, 600, "Exercício Criativo 6.4" );
    ...
    while ( !WindowShouldClose() ) {
        ...
        for (double angulo = 0.0; angulo < 15 * 2 * PI; angulo += 0.05) {
            double raio = a + b * angulo;
            int x = centroX + (int)(raio * cos(angulo));
            int y = centroY + (int)(raio * sin(angulo));
